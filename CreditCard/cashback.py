...
class Cashback:
    ...
    def calculate_reward(self, amount: float) -> None:
        ...
        This method should be called every time a transaction is processed
        in CreditCard.py so that the user's rewards_cash balance reflects
    ...
    def redeem_rewards(self) -> float:
        ...
        This method resets the rewards_cash to 0 and returns the redeemed amount.
